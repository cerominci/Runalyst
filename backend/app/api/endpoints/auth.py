...
@limiter.limit("10/minute")
def login(request: Request, payload: SignUpIn, db: Session = Depends(get_db)):
...
@limiter.limit("10/minute")
def google_login(request: Request, payload: GoogleAuthIn, db: Session = Depends(get_db)):
...
@limiter.limit("10/minute")
def apple_login(request: Request, payload: AppleAuthIn, db: Session = Depends(get_db)):
...
def send_verification(request: Request, payload: EmailIn):
...
@limiter.limit("10/minute")
def verify_email(request: Request, payload: VerifyEmailIn):
