  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <Input label="Email" value={email} setValue={setEmail} autoCapitalize="none" />
        ...
        <TouchableOpacity onPress={() => router.push("/signin")} style={styles.bottomLink}>
...
function Input({ label, value, setValue, ...props }: InputProps) {
  return (
